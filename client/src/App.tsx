                  ...
                  <div className="space-y-4">
                    <div className="grid gap-4">
                      <div className="grid grid-cols-3 gap-4 py-2 border-b">
                        ...
                        <span className="col-span-2 font-semibold">{extractedData.name}</span>
                      </div>
                      <div className="grid grid-cols-3 gap-4 py-2 border-b">
                        <span className="font-medium text-gray-600">Aadhaar Number:</span>
                        <span className="col-span-2 font-mono text-lg">{extractedData.aadhaarNumber}</span>
                      </div>
                      <div className="grid grid-cols-3 gap-4 py-2 border-b">
                        <span className="font-medium text-gray-600">Date of Birth:</span>
                        <span className="col-span-2">{extractedData.dob}</span>
                      </div>
                      <div className="grid grid-cols-3 gap-4 py-2 border-b">
                        <span className="font-medium text-gray-600">Gender:</span>
                        <span className="col-span-2">{extractedData.gender}</span>
                      </div>
                      {extractedData.fatherName && (
                        <div className="grid grid-cols-3 gap-4 py-2 border-b">
                          <span className="font-medium text-gray-600">Father's Name:</span>
                          <span className="col-span-2">{extractedData.fatherName}</span>
                        </div>
                      )}
                      {extractedData.phoneNumber && (
                        <div className="grid grid-cols-3 gap-4 py-2 border-b">
                          <span className="font-medium text-gray-600">Phone Number:</span>
                          <span className="col-span-2">{extractedData.phoneNumber}</span>
                        </div>
                      )}
                      <div className="grid grid-cols-3 gap-4 py-2">
                        <span className="font-medium text-gray-600">Address:</span>
                        <span className="col-span-2">{extractedData.address}</span>
                      </div>
                    </div>
